...
<div id="appTransaccionesFlag" class="appTransaccionesFlag"></div>
  ...
  <input type="hidden" value="{{ route('verificarFacturaCabecera.proceso_1') }}" id="verificarFacturaCabecera" class="dct_main">
  <input type="hidden" value="{{ route('obtenerDataProductoServicio.proceso_2') }}" id="obtenerDataProductoServicio" class="dct_main">
  <input type="hidden" value="{{ route('generarFacturaCabecera.proceso_3') }}" id="generarFacturaCabecera" class="dct_main">
        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div id="transPanel_1" class="dct_main">
                <br>
                <div class="row">
                  <div class="col-md-6">
        ...
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-9">
                  <div class="dct_main" id="transPanel_2">
                    <div class="row">
                      <div class="col-md-6">
              ...
              <div id="transPanel_3" class="dct_main">
...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('vendor/dct_sistema/dist/css/webPOSTransacciones.css') }}" />
@stop
...
@section('js')
    ...
    <script src="{{ asset('vendor/dct_sistema/dist/js/webPOSTransacciones.js') }}"></script>
@stop