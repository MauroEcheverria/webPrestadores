        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right" id="num_pass_cambio">
              <img src="{{ asset('vendor/dct_sistema/dist/img/alerta_gif.gif') }}" alt="" class="img_pass_cambio">
              <strong><span class="num_pass_cambio"><?php echo "5"; ?></span> día(s) para cambio de contraseña</strong> 
            </ol>
          </div>
        </div>
      </div>
...
@section('js')
    ...
    <script src="{{ asset('vendor/dct_sistema/dist/js/dashboard2.js') }}"></script>
    <script src="{{ asset('vendor/dct_sistema/dist/js/dashboard3.js') }}"></script>
@stop