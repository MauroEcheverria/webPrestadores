        ...
        <tbody>
            <tr style="vertical-align:top" valign="top">
                <td style="word-break:break-word;vertical-align:top" valign="top">
                                        ...
                                        <div style="border-top:0px solid transparent;border-left:0px solid transparent;border-bottom:0px solid transparent;border-right:0px solid transparent;padding-top:5px;padding-bottom:15px;padding-right:0px;padding-left:0px">
                                            ...
                                            <div>
                                              ...
                                              <div align="center" style="font-size:17px;color:#000000;padding-top: 15px;padding-right:0px;padding-left:0px;font-weight: bold;text-decoration: underline;">
                                                <span>Solicitud de Reestablecimiento de Contrase&ntilde;a</span>                                            
                                              </div>
                                                ...
                                                <p style="text-align: justify;">
                                                  <span>
                                                    ...
                                                    Para proceder a realizar el reestablecimiento de su contraseña favor de clic en el bot&oacute;n que se muestra a continuaci&oacute;n.
                                            ...
                                            <div >
                                              <h2 style="text-align: justify; padding: 15px;">
                                                  <a href="%%host%%webAdministracion/pages/login/restablecerContrasena.php?linkReset=%%linkReset%%">
                                            ...
                                            <div>
                                               <p style="text-align: justify;">
                                                <span style="font-size: 12px;text-decoration: underline;font-weight: bold;color: #000;">
                                                  Favor no responder a este correo electr&oacute;nico ya que fue generado autom&aacute;ticamente por el sitio web.
                                                </span>
                                              </p>
                                            </div>
                    ...
                    <div style="background-color:transparent">
                        <div class="m_-2705608194777788038block-grid" style="margin:0 auto;min-width:320px;max-width:500px;word-wrap:break-word;word-break:break-word;background-color:transparent">
                            <div style="border-collapse:collapse;display:table;width:100%;background-color:transparent">
                                    ...
                                    <div style="width:100%!important">
                                        ...
                                        <div style="border-top:0px solid transparent;border-left:0px solid transparent;border-bottom:0px solid transparent;border-right:0px solid transparent;padding-top:5px;padding-bottom:10px;padding-right:0px;padding-left:0px">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed;vertical-align:top;border-spacing:0;border-collapse:collapse;min-width:100%" role="presentation" valign="top">
                                                <tbody>
                                                    <tr style="vertical-align:top" valign="top">
                                                        <td style="word-break:break-word;vertical-align:top;min-width:100%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px" valign="top">
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed;vertical-align:top;border-spacing:0;border-collapse:collapse;border-top:1px solid #7bafd4;width:100%" align="center" role="presentation" valign="top">
                                                                <tbody>
                                                                    <tr style="vertical-align:top" valign="top">
                                ...
                                <div class="m_-2705608194777788038col" style="min-width:320px;max-width:500px;display:table-cell;vertical-align:top;width:500px">
                                    <div style="width:100%!important">
                                        ...
                                        <div style="border-top:0px solid transparent;border-left:0px solid transparent;border-bottom:0px solid transparent;border-right:0px solid transparent;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px">
                                            ...
                                            <div align="center" style="padding-right:0px;padding-left:0px">
                                                <img align="center" border="0" src="https://www.dreconstec.com/images/mail/dct_mail_base_2.png" alt="Image" title="Image" style="text-decoration:none;border:0;height:auto;width:100%;max-width:500px;display:block" width="500" class="CToWUd a6T" tabindex="0"><div class="a6S" dir="ltr" style="opacity: 0.01; left: 677px; top: 82px;"><div id=":14h" class="T-I J-J5-Ji aQv T-I-ax7 L3 a5q" role="button" tabindex="0" aria-label="Descargar el archivo adjunto " data-tooltip-class="a1V" data-tooltip="Descargar"><div class="akn"><div class="aSK J-J5-Ji aYr"></div></div></div></div>
