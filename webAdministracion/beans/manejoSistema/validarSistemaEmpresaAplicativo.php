<?php
  ...
  try {
    ...
    $sql="SELECT ape_estado
          FROM dct_sistema_tbl_aplicacion_empresa
          WHERE ape_id_empresa = :ape_id_empresa
          AND ape_id_aplicacion =:ape_id_aplicacion;";
    $query=$pdo->prepare($sql);
    $query->bindValue(':ape_id_empresa',$_POST["emp_empresa_1"],PDO::PARAM_INT);
    $query->bindValue(':ape_id_aplicacion',$_POST["apl_aplicacion_1"],PDO::PARAM_INT);
    $query->execute();
