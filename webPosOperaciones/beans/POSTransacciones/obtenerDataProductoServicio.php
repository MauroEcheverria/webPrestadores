  ...
  try {
    ...
    foreach ($row_seg_fas as $row_seg_fas) {
      ...
      switch ($row_seg_fas["prs_iva_cod_tarifa"]) {
        case '0':
          $pos_base_imp_iva_cero += $pos_trans_sub_total * $row_seg_fas["trf_porcentaje_iva"] / 100;
          break;
        case '2':
          $pos_base_imp_iva_12 += $pos_trans_sub_total * $row_seg_fas["trf_porcentaje_iva"] / 100;
          break;
        case '3':
          $pos_base_imp_iva_14 += $pos_trans_sub_total * $row_seg_fas["trf_porcentaje_iva"] / 100;
          break;
        case '6':
          $pos_base_imp_iva_no_sujeto += $pos_trans_sub_total * $row_seg_fas["trf_porcentaje_iva"] / 100;
          break;
        case '7':
          $pos_base_imp_iva_exento += $pos_trans_sub_total * $row_seg_fas["trf_porcentaje_iva"] / 100;
          break;
        case '8':
          $pos_base_imp_iva_diferenciado += $pos_trans_sub_total * $row_seg_fas["trf_porcentaje_iva"] / 100;
          break;
      }
