<?php
  ...
  try {
    ...
    $cont=0;
      ...
      $data_result["dataModal_3"] = 'La cédula o pasaporte ingresado ya se encuentra registrado en nuestro sistema. Si tiene inconvenientes favor escribir a info@meditategy.com';
