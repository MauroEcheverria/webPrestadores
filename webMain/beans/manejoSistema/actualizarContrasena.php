<?php
    ...
    $query_3->bindValue(':usr_contrasenia',$validacionUsuario->setPassword(cleanData("noLimite",0,"noMayuscula",$_POST["valPaciente"])));
    $query_3->bindValue(':usr_cod_usuario',cleanData("siLimite",13,"noMayuscula",$_POST["editCedula"]));
