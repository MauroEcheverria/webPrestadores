<?php
    ...
    $query->bindValue(':rla_id_aplicacion', cleanData("noLimite",0,"noMayuscula",$_POST["sys_id_app"])); 
    $query->execute();
    ...
    $query->bindValue(':opc_id_aplicacion', cleanData("noLimite",0,"noMayuscula",$_POST["sys_id_app"])); 
    $query->execute();
		if($query) {
			$pdo->commit();
