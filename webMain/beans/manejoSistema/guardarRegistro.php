<?php
	...
	try {
		...
		$tokenAsignado = $_POST["newCedula"].$fechaActual_3;
	    ...
	    $query_1->bindValue(':tok_cedula', $_POST["newCedula"]);
	    $query_1->execute();
	    ...
	    $query->bindValue(':usr_contrasenia', $validacionUsuario->setPassword(cleanData("noLimite",0,"noMayuscula",$_POST["valPaciente"]))); 
	    ...
	    $query->bindValue(':usr_usuario_creacion', $usr_cedula);
	    ...
	    $query_2->bindValue(':usr_usuario_creacion', $usr_cedula);
