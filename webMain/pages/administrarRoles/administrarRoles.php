...
<div class="container container_main">
  <span id="selectAdminRoles" class="selectAdminRolesClass"></span>
  <section class="sectionDataTable contentNegocio">
    <div class="card">
      ...
      <div class="card-body" align="center">
        <div class="form-group adminRoles_1">
          <select class="form-control adminRoles_3" name= "sys_selec_roles" id="sys_selec_roles" data-placeholder="Lista de Roles">
          </select>
        </div>
      ...
      <div class="modal-header">
        <div class="row">
          ...
          <div class="col-md-11 adminContra_3">
            <h4 class="modal-title" id="myModalLabel">Asignación de App según Rol</h4>
          </div>
        </div>
      </div>
      <div class="modal-body">
          <form id="formSysApp" class="formModalPages" data-toggle="validator" role="form">
            ...
            <div class="form-group">
              ...
              <button type="submit" class="btn btn-default btn-estandar-dreconstec">Asignar</button>
            </div>
          </form>
      </div>
    </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <div class="row">
          ...
          <div class="col-md-11 adminContra_3">
            <h4 class="modal-title" id="myModalLabel">Asignación de Opciones según Rol</h4>
          </div>
        </div>
      </div>
      <div class="modal-body">
