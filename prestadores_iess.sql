...
--
-- Servidor: localhost
-- Tiempo de generación: 08-03-2022 a las 03:31:44
...
(1, 'Sistema', '../../../webMain', 'AC', 'Sistemas', 'Loco', 'indexLinkTics', 'fa fa-laptop'),
(2, 'Facturación', '../../../webFacturacion', 'AC', 'Facturación', 'Web', 'indexLinkFacturacion', 'fa fa-laptop'),
(3, 'Salud', '../../../webSalud', 'AC', 'Salud', 'Web', 'indexLinkSalud', 'fa fa-laptop');
...
(22, 'dFoxdnY4cjZ0d1BFNWRBZmxUL1ZLUW9QaWRUalJQZEU4SWFPQVNuS1ovRXNOYzlGMURSVFJuRGVNVHZ6ajBtRQ==', '1234567891', '2022-02-25 14:50:27', 'IN'),
(23, 'QWJkeEVnd0NTZ2k0Y2QybkhwVG9MeTBCVnJzUjk4OHd6L1NRWUk1TS9xUjVUeGZ1U0pTQk5pZXhrb2huVFB0TA==', '1234567891', '2022-02-25 14:50:30', 'AC');
...
(1, 'Dreconstec', '0919664854001', 'AC', '2022-02-08', '2500-12-31'),
(2, 'Odontocenter Salud', '0264650623001', 'AC', '2022-02-08', '2022-02-28'),
(3, 'Medical Factura', '0264781245001', 'AC', '2022-02-08', '2022-02-28');
...
(1, 'Bienvenido', 'AC', '/pages/bienvenido', 1, 1),
(2, 'Administrar Usuarios', 'AC', '/pages/administrarUsuarios', 1, 2),
(3, 'Administrar Roles', 'AC', '/pages/administrarRoles', 1, 3),
(4, 'Administrar Perfíl', 'AC', '/pages/administrarPerfil', 1, 4);
...
CREATE TABLE `dct_sistema_tbl_token` (
  ...
  `tok_estado` varchar(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `dct_sistema_tbl_usuario` (
  ...
  `usr_logeado` varchar(2) NOT NULL,
  `usr_estado` varchar(2) NOT NULL,
  ...
  `usr_estado_contrasenia` varchar(2) NOT NULL,
  ...
  `usr_expiro_contrasenia` varchar(2) DEFAULT NULL,
