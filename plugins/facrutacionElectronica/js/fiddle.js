function obtenerComprobanteFirmado_sri(ruta_certificado, pwd_p12, ruta_respuesta, ruta_factura, id) {
                ...
                $.ajax({
                    ...
                    if (/RECIBIDA/i.test(respuesta) || /CLAVE ACCESO REGISTRADA/i.test(respuesta)) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                'service': service, 'claveAcceso': $claveAcceso.text(), 'id_comprobante' : id
                            },
                            context: document.body
