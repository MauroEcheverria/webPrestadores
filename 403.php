          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="error-content">
                ...
                <p>
                  Al parecer no tienes acceso a esta sección de la página WEB. Mientras tanto, puede volver al <a href="webAdministracion/pages/principal/">panel de control.</a>
                </p>
              </div>
            </div>
          </div>
