...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-07-2022 a las 06:11:04
...
CREATE TABLE `dct_sistema_tbl_catalogo` (
  ...
  `ctg_usuario_creacion` varchar(13) DEFAULT NULL,
  `ctg_usuario_modificacion` varchar(13) DEFAULT NULL,
  `ctg_fecha_creacion` timestamp NULL DEFAULT NULL,
  `ctg_fecha_modificacion` timestamp NULL DEFAULT NULL,
  `ctg_ip_creacion` varchar(100) DEFAULT NULL,
  `ctg_ip_modificacion` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `dct_sistema_tbl_empresa` (
  ...
  `em_contrasenia` varchar(40) DEFAULT NULL,
...
INSERT INTO `dct_sistema_tbl_empresa` (`emp_id_empresa`, `emp_empresa`, `emp_ruc`, `emp_estado`, `emp_vigencia_desde`, `emp_vigencia_hasta`, `em_contrasenia`) VALUES
(1, 'Dreconstec', '0919664854001', 1, '2022-02-08', '2500-12-31', 'Maruto1984');
...
(5, 'Principal', 1, '/pages/principal', 2, 6),
(6, 'Venta Facturación', 1, '/pages/ventaFacturacion', 2, 6);
...
('0919664854', 'Mauro', 'Vinicio', 'Echeverría', 'Chugulí', 'amkyZWwvV0EzTjA5Q2kvKy85aUoxQjh3K1dxZ3kxQlp6NnBwb0E3cGRmVS9VL3cxcHJwOEZaT0tRa2V3N2hSNw==', 1, 1, '::1', '2022-07-25 03:21:42', 'maurovinicio.echeverria@gmail.com', 1, 1, 1, '2022-07-22', 0, 0, '2022-07-24', '0919664854', '0919664854', '2021-05-19 10:20:25', '2021-05-19 10:20:25', 'DESKTOP-5L9FRDR', 'DESKTOP-5L9FRDR');
...
('0919664854', '2022-07-05', 'MASCULINO', 'VIUDO/A', 'BASICA', 'B -', '593960939030', 'PR_01', 'CN_0102', 'PQ_010251', 'DSDF', 'SDFSDF', '0919664854', NULL, '2022-07-25 03:20:27', NULL, '::1', NULL);
