...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-07-2022 a las 05:53:10
...
(2, 'Mi Negocio', '../../../webMiNegocio', 1, 'Mi Negocio', 'Web', 'indexLinkFacturacion', 'fa fa-laptop'),
...
INSERT INTO `dct_sistema_tbl_aplicacion_empresa` (`ape_id_aplicacion`, `ape_id_empresa`, `ape_estado`) VALUES
(1, 1, 1),
(1, 2, 1),
(1, 3, 1),
(2, 1, 1),
...
(22, 'dFoxdnY4cjZ0d1BFNWRBZmxUL1ZLUW9QaWRUalJQZEU4SWFPQVNuS1ovRXNOYzlGMURSVFJuRGVNVHZ6ajBtRQ==', '1234567891', '2022-03-18 18:57:03', 1),
(23, 'QWJkeEVnd0NTZ2k0Y2QybkhwVG9MeTBCVnJzUjk4OHd6L1NRWUk1TS9xUjVUeGZ1U0pTQk5pZXhrb2huVFB0TA==', '1234567891', '2022-03-18 18:57:05', 1);
...
(1, 'Dreconstec', '0919664854001', 1, '2022-02-08', '2500-12-31'),
(2, 'Odontocenter Salud', '0264650623001', 1, '2022-02-08', '2022-02-28'),
(3, 'Medical Factura', '0264781245001', 1, '2022-02-08', '2022-02-28');
...
(1, 'Bienvenido', 1, '/pages/bienvenido', 1, 1),
(2, 'Usuarios', 1, '/pages/administrarUsuarios', 1, 2),
(3, 'Sistema', 1, '/pages/administrarSistema', 1, 3),
(4, 'Perfíl', 1, '/pages/administrarPerfil', 1, 4),
(5, 'Principal', 1, '/pages/principal', 3, 1),
(6, 'Admisión', 1, '/pages/Admisión', 3, 2),
(7, 'Enfermería', 1, '/pages/estacionEnfermeria', 3, 3),
(8, 'Médicos', 1, '/pages/atencionMedica', 3, 4),
(9, 'Historia Clínical', 1, '/pages/historiaClínica', 3, 5),
(10, 'Estadística', 1, '/pages/estadistica', 3, 7),
(11, 'Reportes', 1, '/pages/resportes', 3, 8),
(12, 'Administración', 1, '/pages/administracion', 3, 9),
(13, 'Consulta de Citas', 1, '/pages/consultaCitas', 3, 6),
(14, 'Principal', 1, '/pages/principal', 2, 6),
(15, 'Venta Facturación', 1, '/pages/ventaFacturacion', 2, 6);
...
(1, '0919664854', 'Mauro', 'Vinicio', 'Echeverría', 'Chugulí', 'amkyZWwvV0EzTjA5Q2kvKy85aUoxQjh3K1dxZ3kxQlp6NnBwb0E3cGRmVS9VL3cxcHJwOEZaT0tRa2V3N2hSNw==', 1, 1, '::1', '2022-07-23 03:40:50', 'maurovinicio.echeverria@gmail.com', 1, 1, 1, '2022-07-22', 0, 0, '2022-07-22', '0919664854', '0919664854', '2021-05-19 10:20:25', '2021-05-19 10:20:25', 'DESKTOP-5L9FRDR', 'DESKTOP-5L9FRDR'),
(90, '3353', 'ETRETR', 'ETERT', 'ETET', 'ETR', 'Tk56RTVmSlRzeFVmbkFhMGZhdmg4b1ZVQmttQ1dvdzFScEs3bXlGeHdrMFRsS1Q3T3hsdUhzZDZmWWVSSnFPMg==', 0, 1, NULL, NULL, 'kaceto104@gmail.com', 2, 1, 1, '2022-07-22', 0, 1, NULL, '0919664854', '0919664854', '2022-07-23 03:20:54', '2022-07-23 03:38:33', '::1', '::1');
...
--
ALTER TABLE `dct_sistema_tbl_usuario`
  MODIFY `usr_id_usuario` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
