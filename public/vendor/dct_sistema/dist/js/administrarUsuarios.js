$(document).ready(function() {
    window.dtUsuarios = $('#dtUsuarios').DataTable( {
        ...
        createdRow: function ( row, data, index ) {
            if ( data[5] == 1 ) {
                $('td', row).eq(5).html("<div align='center'><div style='display:none;'>Activo</div><img id='okEvalu' src='../../../vendor/dct_sistema/dist/img/x-visto.png' style='width: 17px;'/></div>");
            }
            if ( data[5] == 0 ) {
                $('td', row).eq(5).html("<div align='center'><div style='display:none;'>Inactivo</div><img id='errorEvalu'src='../../../vendor/dct_sistema/dist/img/x-error.png' style='width: 17px;'/></div>");
            }
            if ( data[6] == 1 ) {
